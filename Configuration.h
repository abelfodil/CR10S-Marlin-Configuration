...
#define CONFIG_EXAMPLES_DIR "config/examples/Creality/CR-10S/BLTouch"
...
#define STRING_CONFIG_H_AUTHOR "(abelfodil, CR-10S BLTouch Marlin 2.x)" // Who made the changes.
